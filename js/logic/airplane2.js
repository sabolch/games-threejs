...
function init() {
    ...
    setTimeout(function () {
        ...
        AirplaneAnimations.spinner = Airplane.mixer.clipAction(clip).play();
...
function key() {
    ...
    //     AirplaneAnimations.spinner.resetDuration ();
    // }
    //
    // if (keyboard.pressed("J")) {
    //     kilora += 0.1;
    //     console.log(kilora);
    //     AirplaneAnimations.spinner.setDuration(kilora);
    //
    // }
    // if (keyboard.pressed("K")) {
    //     kilora -= 0.1;
    //     console.log(kilora);
    //     AirplaneAnimations.spinner.setDuration(kilora);//.resetDuration ()
    //
    // }
